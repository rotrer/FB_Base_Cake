...
<div id="registro" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <form name="data" id="data" method="post" action="<?php echo $this->Html->url(array('controller' => 'usuarios', 'action' => 'save'), true); ?>" class="form-horizontal">
            ...
            <div class="container-fluid modal-body">
                    ...
                    <div class="row-fluid control-group">
                        ...
                        <div class="span8 offset2 input-prepend">
                                ...
                                <input type="text" name="firstname" id="firstname" value="<?php if($userData["firstname"]) echo $userData["firstname"] ?>" class="required text" text="Ingresa tu nombre">
                        </div>
                    ...
                    <div class="row-fluid control-group">
                        ...
                        <div class="span8 offset2 input-prepend">
                                ...
                                <input type="text" name="lastname" id="lastname" value="<?php if($userData["lastname"]) echo $userData["lastname"] ?>" class="required text" text="Ingresa tu apellido">
                        </div>
                    ...
                    <div class="row-fluid control-group">
                        ...
                        <div class="span8 offset2 input-prepend">
                                ...
                                <input type="text" name="email" id="email" value="<?php if($userData["email"]) echo $userData["email"] ?>" class="required email" text="Ingresa tu email">
                        </div>
                    ...
                    <div class="row-fluid control-group text-center bases_concurso">

                        <input type="checkbox" class="required checkbox" text="Debes aceptar las bases." id="bases" name="bases"> He leído y acepto las <a target="_blank" href="#">bases</a> del concurso.
    ...
    <div id="cont_success" class="registroOk" style="display:none;">
